  ...
  const t = document.documentElement,
    ...
    o = () => {
      ...
      if (o) {
        ...
        m
          ? (t.classList.add("gray-" + m),
            (p = o.querySelector(
              "[data-toggle='gray'][data-value='" + m + "']"
            )))
          : (p = o.querySelector("[data-toggle='gray'][data-value='default']")),
          p && p.classList.add("active");
        let g,
          u = localStorage.getItem("font");
        u
          ? (t.classList.add("font-" + u),
            (g = o.querySelector(
              "[data-toggle='font'][data-value='" + u + "']"
            )))
          : (g = o.querySelector("[data-toggle='font'][data-value='default']")),
    ...
    on("#customizer", "click", '[data-toggle="branded-menu"]', () => {
      e &&
        (t.classList.contains("menu_branded")
          ? (t.classList.remove("menu_branded"),
            e.classList.remove("menu_branded"),
      ...
      ((e) => {
        ...
        t.classList.forEach((e) => {
          ...
          "default" == o
            ...
            : (t.classList.add("theme-" + o), localStorage.setItem("theme", o));
      ...
      ((e) => {
        ...
        t.classList.forEach((e) => {
          ...
          "default" == o
            ...
            : (t.classList.add("gray-" + o), localStorage.setItem("gray", o));
        const r = new Event("ThemeChanged");
        document.dispatchEvent(r);
      ...
      ((e) => {
        ...
        t.classList.forEach((e) => {
          ...
          "default" == o
            ...
            : (t.classList.add("font-" + o), localStorage.setItem("font", o));
        const r = new Event("ThemeChanged");
...
if ((darkMode(), "undefined" != typeof Chart)) {
  ...
  (Chart.defaults.color = "rgb(" + t.text + ")"),
    (Chart.defaults.font.family = e.body);
    ...
    draw(e) {
      ...
      if (
        ...
        o.save(),
          ...
          o.lineTo(e, a),
          (o.lineWidth = 1),
          (o.strokeStyle = "rgb(" + t.primary + "/ .25)"),
          o.stroke(),
          o.restore();
      }
    }
  ...
  if (((g = document.getElementById("visitorsChart")), g)) {
    ...
    e.addColorStop(0, "rgb(" + t.primary + "/ .5)"),
      e.addColorStop(0.75, "rgb(" + t.primary + "/ 0)");
  ...
  const u = {
      afterInit: (t) => {
        const e = t.canvas.parentNode,
          ...
          a = t.data.labels[0];
        (e.querySelector(".chart-heading").innerHTML = r),
          (e.querySelector(".chart-value").innerHTML = "$" + o),
          (e.querySelector(".chart-label").innerHTML = a);
      },
    },
    y = {
      plugins: {
  ...
  document.addEventListener("click", (t) => {
    ...
    on(".menu-items", "click", ".link", (t) => {
      ...
      if (r && !o.classList.contains("menu-wide")) {
        ...
        a(),
          r && !t ? (showOverlay(!0), r.classList.add("open")) : hideOverlay();
      }
    });
...
const showOverlay = (t) => {
    ...
    t
      ? e.setAttribute("class", "overlay overlay_workspace")
  ...
  ratingStars = () => {
    (rateStars = (t) => {
      ...
      let r = 0;
      (r = o.length - o.indexOf(t.target)),
        o.forEach((t) => t.classList.remove("active")),
        t.target.classList.add("active"),
        console.log("You have rated " + r + " stars.");
    }),
  ...
  on("body", "click", '[data-toggle="toast"]', (e) => {
    ((e) => {
      ...
      let a =
        ...
        r +
        "</div></div>";
      (a = new DOMParser().parseFromString(a, "text/html").body.firstChild),
        t.appendChild(a),
        animateCSS(a, "fadeInUp");
    })(e.target);
  });
